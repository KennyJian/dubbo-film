...
public interface CinemaServiceApi {
    ...
    Integer getCinemaIdByFieldId(Integer fieldId);

    String getFieldBeginTime(Integer fieldId);

    //根据FieldId找到对应的座位位置图 目前该接口暂时是供订单服务调用
    String getSeatsByFieldId(String fieldId);
    //目前该接口暂时是供订单服务调用
