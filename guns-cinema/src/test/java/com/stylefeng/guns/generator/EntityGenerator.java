...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("E:\\code\\毕设\\guns\\guns-cinema\\src\\main\\java");//这里写你自己的java目录
        ...
        dsc.setPassword("3DSmart");
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/guns_movie_rest?autoReconnect=true&useUnicode=true&characterEncoding=utf8&serverTimezone=GMT%2B8");
        ...
        strategy.setInclude(new String[]{"cinema_hall_film_info_t"});
